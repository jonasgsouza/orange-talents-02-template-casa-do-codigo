...
import br.com.zup.casadocodigo.controller.response.AuthorResponse;
...
public class AuthorController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<AuthorResponse> save(@RequestBody @Valid NewAuthorRequest req, UriComponentsBuilder uriBuilder) {
